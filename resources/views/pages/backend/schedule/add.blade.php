...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('schedule.store') }}" method="POST">
            @csrf
            <div class="card ">
                ...
                <div class="card-body ">
                            ...
                            <div class="form-group">    
                              <select class="form-control" name="movie" id="movie" required="true">
                                ...
                                @foreach ($movie as $item)
                                    <option value="{{ $item['id'] }}">{{ $item['namafilm'] }}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">    
                                <input class="form-control" type="date" name="tanggal" required="true" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">    
                              <input class="form-control" type="time" name="waktu" required="true" />
                          </div>
                      </div>
                  </div>
                </div>
