...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('transaction.store') }}" method="POST">
            @csrf
            <div class="card ">
                ...
                <div class="card-body ">
                            ...
                            <div class="form-group">    
                                <select class="form-control" name="schedule" id="schedule" required="true">
                                    ...
                                    @foreach ($schedule as $item)
                                        <option value="{{ $item['id'] }}">{{ $item['room']['namaRuang'] }} - {{ $item['movie']['namafilm'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">    
                                <input class="form-control" type="number" name="totalHarga" id="totalHarga" required="true" min="0" value="0" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">    
                                <input class="form-control" type="number" name="bayar" id="totalHarga" required="true" min="0" value="0"/>
                            </div>
                        </div>
                    </div>
                </div>
